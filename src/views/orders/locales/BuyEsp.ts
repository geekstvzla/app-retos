export const buyEsp = {
    ...
    note: "<p>Podrás ofrecer el servicio de transporte una vez se genere una <b>Orden de Venta</b> para adquirir tu producto. Es en la <b>Orden de Venta</b> donde se indica el destino del producto para luego poder calculcar el flete.</p><p class='mb-0'>Se te notificará cuando se genere dicha orden.</p>",
    price: {
        example: "Ejemplo: 1.250.908,80",
        label: "Precio"
    },
    searchProduct: {
        help: "Escribe el nombre del producto que vas a comprar",
        label: "Producto"
    },
    buyButton: {
        initText: "Generar orden compra",
