export const buyEng = {
    ...
    note: "When someone generates a <b>Sell Order</b> to acquire your product, you will be able to indicate the freight price in case you wish to offer the transportation service, since the Sell Order indicates the destination of the product.",
    price: {
        example: "Example: 1.250.908,80",
        label: "Price"
    },
    searchProduct: {
        help: "Write the name of the product you are going to buy",
        label: "Product"
    },
    buyButton: {
        initText: "Generate buy order",
        loadingText: "Loading"
    },
