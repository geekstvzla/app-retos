...
import en from './locales/SellEng';
import es from './locales/SellEsp';
...
export default defineComponent({
    ...
    setup() {
        ...
        const attrs = reactive({
            ...
            sellButton:{
                disabled: true,
                html:t('sellButton.initText'),
                initHtml: t('sellButton.initText'),
                loadingHtml: '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span><span class="sr-only"> '+ t('sellButton.loadingText') +'</span>'
            },
            weighingUnit: {
                disabled: true
            }
...
<style lang="less" src="../../assets/less/orders/Sell.less" scoped></style>